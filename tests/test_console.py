...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_help_quit(self):
        h = ("Exit the command-line interface.\n\n"
             "        Args:\n"
    ...
    def test_help_create(self):
        h = ("Create a new instance of a specified class.\n\n"
             "        Args:\n"
    ...
    def test_help_EOF(self):
        expected_output = ("Handle the End-of-File signal.\n\n"
                           "        Args:\n"
                           "            arg (str): The command argument.\n\n"
                           "        Returns:\n"
                           "            bool: True to exit the interface.")
    ...
    def test_help_show(self):
        e = ("Display information about a specific instance.\n\n"
             "        Args:\n"
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            a = output.getvalue().strip()
            self.assertEqual(e, a)

    def test_help_destroy(self):
        e = ("Delete a specific instance.\n\n"
             "        Args:\n"
             "            arg (str): The class name and instance ID.\n\n"
             "        Returns:\n"
             "            None")
    ...
    def test_help_all(self):
        expected = ("Display information about all instances or instances of\n"
                    "        a specific class.\n\n"
                    "        Args:\n"
    ...
    def test_help_count(self):
        expected = ("Count the number of instances of a specific class.\n\n"
                    "        Args:\n"
                    "            arg (str): The class name.\n\n"
                    "        Returns:\n"
                    "            None")
    ...
    def test_help_update(self):
        e = ("Update attributes of a specific instance.\n\n"
             "        Args:\n"
